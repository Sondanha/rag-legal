...
- 관련 문서가 있다면, 답변 끝에 PDF 링크를 보여주되, 다음과 같은 JSON 형태로 작성하세요:

{
    ...
    {
        "title": "문서 제목",
        "url": "http://lsw/flDownload.do?flSeq=1486"
    }
    ]
}
""")
    ...
    # 최종 프롬프트 구성
    prompt = f"""다음은 사용자의 질문과 관련된 문서들입니다.

{reference_sections}

이 문서들을 참고하여 아래 질문에 정확하게 답하세요:
...
"""
    ...
    return {**state, "prompt": prompt.strip()}
